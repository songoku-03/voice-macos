...
This project is indexed by GitNexus as **voice-macos** (2474 symbols, 6412 relationships, 174 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
