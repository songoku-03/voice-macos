...
This project is indexed by GitNexus as **voice-macos** (2036 symbols, 5145 relationships, 138 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
