...
This project is indexed by GitNexus as **voice-macos** (1551 symbols, 3878 relationships, 117 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
