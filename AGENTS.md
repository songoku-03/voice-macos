...
This project is indexed by GitNexus as **voice-macos** (1289 symbols, 3055 relationships, 99 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
