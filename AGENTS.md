...
This project is indexed by GitNexus as **voice-macos** (1551 symbols, 3880 relationships, 114 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
