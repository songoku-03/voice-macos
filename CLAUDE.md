...
This project is indexed by GitNexus as **voice-macos** (2031 symbols, 5132 relationships, 138 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
