...
This project is indexed by GitNexus as **voice-macos** (2009 symbols, 5083 relationships, 138 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
